            ...
            .then(data => {
                this.setState({
                    formData: {
                        ...
                        downforceCoefficient: data.downforceCoefficient,
                        dragCoefficient: data.dragCoefficient,
                        brakePressureTorqueRatio: data.brakePressureTorqueRatio,
                        mass: data.mass,
                        powerMax: data.powerMax,
                        torqueMax: data.torqueMax,
                        rpmPowerMax: data.rpmPowerMax,
                        rpmTorqueMax: data.rpmTorqueMax,
                        numberOfGears: data.numberOfGears,
                        gears: data.gears,
                        finalDriveRatio: data.finalDriveRatio,
                        longitudinalGrip: data.longitudinalGrip,
                        lateralGrip: data.lateralGrip,
                        tyreRadius: data.tyreRadius
                    }
                });
            })
        ...
        return (
            <div className={"add-vehicle-container"}>
                ...
                <form>
                    ...
                    <Link to={"/"}>
                        <button type={"submit"} onClick={this.handleUpdateVehicle}>Edit Vehicle</button>
                    </Link>
                </form>
