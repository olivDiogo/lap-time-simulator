...
class VehicleControllerTest {
    ...
    void shouldCreateCombustionVehicle_whenParametersAreValid() throws Exception {
        ...
        VehicleDataInDTO vehicleDataDTO = new VehicleDataInDTO(null, vehicleName, downforceCoefficient, dragCoefficient, pressureToTorqueRatio, mass, powerMax, torqueMax, rpmPowerMax, rpmTorqueMax, powertrainType, numberOfGears, gears, finalDriveRatio, longitudinalGrip, lateralGrip, tyreRadius);
    ...
    void shouldGetListOfVehicles_whenVehiclesExist() throws Exception {
        ...
        VehicleDataInDTO vehicleDataDTO = new VehicleDataInDTO(null, vehicleName, downforceCoefficient, dragCoefficient, pressureToTorqueRatio, mass,
    ...
    void shouldUpdateVehicle_whenParametersAreValid() throws Exception {
        ...
        /* Update vehicle name */
        String updatedVehicleName = "ElectricVehicleUpdated";
        VehicleDataInDTO updateVehicleDataInDTO = new VehicleDataInDTO(vehicle.getVehicleID().getId(), updatedVehicleName, downforceCoefficient, dragCoefficient, pressureToTorqueRatio, mass,
                powerMax, torqueMax, rpmPowerMax, rpmTorqueMax, powertrainType, numberOfGears, gears, finalDriveRatio, longitudinalGrip, lateralGrip, tyreRadius);

        VehicleParameters updatedVehicleParameters = VehicleParametersUtils.getVehicleParameters(updateVehicleDataInDTO);
        IVehicleFactory updatedVehicleFactory = new VehicleFactory();
        Vehicle updatedVehicle = updatedVehicleFactory.createVehicle(updatedVehicleParameters);
        ...
        assertEquals(updatedVehicleName, vehicleDataOutDTO.vehicleName);
    }
    ...
    void shouldGetNotFound_whenVehicleDoesNotExist() throws Exception {
        ...
        VehicleDataInDTO updateVehicleDataInDTO = new VehicleDataInDTO(vehicle.getVehicleID().getId(), vehicleName, downforceCoefficient, dragCoefficient, pressureToTorqueRatio, mass,
                powerMax, torqueMax, rpmPowerMax, rpmTorqueMax, powertrainType, numberOfGears, gears, finalDriveRatio, longitudinalGrip, lateralGrip, tyreRadius);
