...
class VehicleFactoryTest {
    ...
    void shouldCreateVehicle_whenVehicleIDAndVehicleParametersAreValid() {
        ...
        try (MockedConstruction<VehicleID> vehicleIDMocked = mockConstruction(VehicleID.class)) {
            //Act
            Vehicle vehicle = vehicleFactory.createVehicle(vehicleID, vehicleParameters, 1);
    ...
    void shouldThrowIllegalArgumentException_whenVehicleIDIsNull() {
        ...
        //Act & Assert
        Exception e = assertThrows(IllegalArgumentException.class, () -> vehicleFactory.createVehicle(null, vehicleParameters, 1));
    ...
    void shouldThrowIllegalArgumentException_whenVehicleIDIsValidAndVehicleParametersAreNull() {
        ...
        //Act & Assert
        Exception e = assertThrows(IllegalArgumentException.class, () -> vehicleFactory.createVehicle(vehicleID, null, 1));
